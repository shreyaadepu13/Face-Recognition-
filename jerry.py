...
btn_gmail_open = Button(win,text="info@sbionline.com",fg="White",bg='Orange',relief=SUNKEN,borderwidth=0,cursor="hand2")
...
img_face=PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\face_m.png")
