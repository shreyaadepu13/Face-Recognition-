...
win.title("NetBank Login:")
win.iconbitmap("C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\bitmap_6.ico")
...
def win_signup_alert():
    ms.showerror("Hey",'You are already on Sign Up page')


def win_login():
    win3=Toplevel(win)
    win3.geometry("400x350")
    win3.title("NetBank Login:")
    win3.iconbitmap("C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\bitmap_4.ico")
    ...
    idk = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\login.png")
    ...
    def db_signin():
        ...
        if result:
            ...
            win4.title("NetBank Login:")
            win4.iconbitmap("C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\bitmap_4.ico")

            canvas1_win4 = Canvas(win4,width=300,height=250,bg="Green")                          #
            canvas1_win4.place(x=0,y=0)
            success_login_msg=canvas1_win4.create_text(150,125,text="Succesfully Logged In!",fill="#FF8F00",font=("Boulder Bold",18))
...
def db_signup():
    ...
    if len(Fullname.get())!=0:
        ...
        conn.commit()
        final_message.configure(text="Successfully Submitted")
    else:
        final_message.configure(text="Fill in all the Details!")


img_fb = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\fb_s.png")
...
img_tw = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\twitter_s.png")
...
img_insta = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\insta_s.png")
...
img_yt = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\yt_s.png")
...
img_reg = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\regis.png")
...
img_login = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\login.png")
...
img_msg = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\msg.png")
canvas1.create_image(564,19,image=img_msg)
btn_gmail_open = Button(win,text="info@sbionline.com",fg="White",bg='Green',relief=SUNKEN,borderwidth=0,cursor="hand2",command=OpenGmail)
btn_gmail_open.configure(width=15,height=1)
canvas1.create_window(630,19,window=btn_gmail_open)
"""canvas1.create_text(630,19,text="info@sbionline.com",fill="white")"""


img_gg = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\gg.png")
...
img_home = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\home.png")
...
img_edit=PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\edit.png")
...
img_user = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\user_1.png")
...
img_contact = PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\contact_1.png")
...
url_pizza="https://www.onlinesbi.com/"
def OpenPizza():
    webbrowser.open_new(url_pizza)
pizza = Button(win,text="Developer",fg="#FF8F00",relief=SUNKEN,borderwidth=0,cursor="hand2",command=OpenPizza)
pizza.configure(font=("Boulder Bold",20))
pizza_window = canvas_end.create_window(215, 70, anchor=NW, window=pizza)

img_pizza=PhotoImage(file="C:\\Users\\Sreeranjan\\Desktop\\Face_Recognition-Python-Project-4th-Sem-master\\GUI\\Icons\\pizza.png")
